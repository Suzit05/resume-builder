...
const Home = () => {
    return (
        <div className='flex flex-col'>
            <Navbar></Navbar>
            <div className='flex  justify-center items-center px-[4vw] py-[15vh] gap-[12vw] bg-gray-100 '>
                <div className='  py-[4vh] '> <h1 className='font-bold text-[6vh]'>Online Resume Builder: <br /> Make Your Resume Fast <br /> without Log in.</h1>
                    ...
                    <button className='Create-btn bg-[#d4bd67] px-[6vw] py-2 rounded-xl font-bold text-lg mt-4'  >Create Your Resume Now</button>
                </div>
