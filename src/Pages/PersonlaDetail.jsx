            ...
            <div className=' flex justify-center items-center p-8 mt-[4vh] gap-[16vw] bg-gray-100'>
                <div className='flex-col flex gap-[3vh] justify-center items-center'>
                    <div className='each-input flex '>
                        <input className='border-2 p-2 w-[24vw]' type="text" placeholder='First Name*' required />

                    </div>

                    <div className='each-input flex '>
                        <input className='border-2 p-2 w-[24vw]' type="email" placeholder=' Email*' required />
                    ...
                    <div className='each-input flex '>
                        <input className='border-2 p-2 w-[24vw]' type="text" placeholder='Website' />
                    ...
                    <div className='each-input flex '>
                        <input className='border-2 p-2 w-[24vw]' type="text" placeholder='Linked in' />
                ...
                <div className='flex-col flex gap-[3vh] justify-center items-center'>
                    ...
                    <input className='border-2 p-2 w-[24vw]' type="text" placeholder='Last Name*' required />

                    <div className='each-input flex '>
                        <input className='border-2 p-2 w-[24vw]' type="email" placeholder=' Phone number*' required />
                    ...
                    <div className='each-input flex '>
                        <input className='border-2 p-2 w-[24vw]' type="text" placeholder='Github' />
                    ...
                    <div className='each-input flex '>
                        <input className='border-2 p-2 w-[24vw]' type="text" placeholder='Twitter' />
