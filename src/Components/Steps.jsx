...
const Steps = () => {
    return (
        <div className=' flex flex-col justify-center items-center gap-[4vh] mt-[8vh]'> <h1 className='text-4xl font-semibold'>Simple four steps to create your resume:</h1>
            ...
            <button className='Create-btn bg-[#d4bd67] px-[6vw] py-2 rounded-xl font-bold text-xl mt-4'  >Create Your Resume Now</button>
        </div>
    )
}
